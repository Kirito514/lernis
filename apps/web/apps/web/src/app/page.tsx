          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              ...
              <div>
                ...
                <p className="mb-2 text-sm font-semibold uppercase tracking-widest text-blue-600">Blockchain Certificates</p>
                ...
                <p className="mt-3 max-w-xl text-gray-600 text-base md:text-lg">
                  Create, mint and verify education credentials as NFTs on Polygon. No registration. Share via link or QR.
                </p>

                <div className="mt-4 flex flex-col sm:flex-row items-center gap-3">
                  <Link href="/auth/register" className="inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-semibold text-white bg-gray-900 hover:bg-black transition">
                    Get Started
               ...
               <div className="relative flex items-center justify-center mt-8 lg:mt-0">
                 <Image 
                   ...
                   width={800}
                   height={600}
                   className="w-full max-w-[500px] sm:max-w-[700px] lg:max-w-[900px] h-[300px] sm:h-[450px] lg:h-[550px] object-contain"
                   priority
                 />
               </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Join thousands of institutions already using EduNFT
            </p>
          </div>
      ...
      <section id="features" className="py-16 relative">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">Discover the powerful capabilities that make EduNFT the leading platform for blockchain-based educational credentials.</p>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid lg:grid-cols-2 gap-6 items-center mb-10">
            <div>
              ...
              <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-3">About EduNFT</h2>
              <p className="text-base text-gray-600 leading-relaxed">
                EduNFT is a revolutionary platform that transforms traditional educational credentials into verifiable, tamper-proof NFTs on the blockchain.
              </p>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="rounded-2xl bg-white/90 backdrop-blur border border-gray-200/50 p-6 shadow-lg hover:shadow-xl transition-all duration-300 relative group hover:-translate-y-1">
              ...
              <Link href="/auth/register" className="w-full bg-gray-900 text-white rounded-full px-5 py-2.5 font-semibold hover:bg-black transition block text-center">
                Get Started Free
              </Link>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="mb-12">
           ...
           <div className="space-y-3">
             {[
               {
                 question: "What is EduNFT?",
                 answer: "EduNFT is a blockchain-based platform that allows educational institutions to mint and verify certificates as NFTs, ensuring authenticity and preventing fraud."
               },
               {
        ...
        <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Join thousands of institutions already using EduNFT. Start your free trial today.
            </p>
