              ...
              <div className="space-y-6">
                ...
                {!isGaslessEnabled ? (
                  <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6 text-center">
                    ...
                    <h3 className="text-lg font-semibold text-yellow-900 mb-2">Gasless Minting Not Available</h3>
                    <p className="text-yellow-700 mb-4">Please connect your wallet to enable gasless certificate minting</p>
                    <button
                      onClick={async () => {
                        ...
                        if (success) {
                          toast.success('Wallet connected! Gasless minting is now enabled.');
                        } else if (walletError) {
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <h4 className="text-sm font-medium text-green-900">🚀 Gasless Minting Active</h4>
            ...
            <div className="space-y-4">
                    <div>
                          ...
                          <input
                            ...
                            onChange={(e) => setCertificateData(prev => ({ ...prev, studentAddress: e.target.value }))}
                    ...
                    <div>
                          ...
                          />
                          <p className="text-xs text-gray-500 mt-1">Student will receive notification about the certificate</p>
                    </div>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => setCertificateData(prev => ({ ...prev, course: e.target.value }))}
                            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    ...
                    <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">Grade/Score</label>
                            <input
                              type="text"
                      ...
                      <button
                        onClick={async () => {
                          // Validate form
                          if (!certificateData.studentAddress || !certificateData.studentEmail || !certificateData.title || !certificateData.course) {
                            toast.error('Please fill in all required fields');
                            return;
                          }

                          // Validate wallet address format
                          if (!certificateData.studentAddress.startsWith('0x') || certificateData.studentAddress.length !== 42) {
                          ...
                          if (!emailRegex.test(certificateData.studentEmail)) {
                          ...
                          try {
                            ...
                            const certificateMetadata = {
                              ...
                              issuer: userData?.fullName || userData?.email || 'EduNFT',
                            ...
                            // Check if MetaMask is connected for real NFT minting
                            if (!isConnected) {
                            ...
                            updateMintingStep(5);
                            try {
                              await notifyRecipient(certificateData.studentEmail, {
                                ...certificateMetadata,
                            ...
                            toast.error(`Failed to mint certificate: ${error.message}`, { id: 'minting' });
                        ...
                        className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 px-6 rounded-lg font-semibold text-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
                        disabled={!isConnected}
                      >
{!isConnected ? '🔒 Connect MetaMask First' : '🚀 Mint Certificate (Real NFT)'}
                      </button>
                    </div>
                  </div>
                )}
